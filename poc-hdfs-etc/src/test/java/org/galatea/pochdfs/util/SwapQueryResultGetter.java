...
public class SwapQueryResultGetter {
	...
	public UnpaidCashResults getUnpaidCashResults(final String book, final String effectiveDate) {
		return new UnpaidCashResults(analyzer.getUnpaidCash(book, effectiveDate));
	}

	public EnrichedPositionsResults getEnrichedPositionResults(final String book, final String effectiveDate) {
	...
	public EnrichedPositionResult getSingleEnrichedPositionResult(final String book, final String effectiveDate) {
		EnrichedPositionsResults results = getEnrichedPositionResults(book, effectiveDate);
		return results.getSingleResult();
	}

	public UnpaidCashResult getSingleUnpaidCashResult(final String book, final String effectiveDate) {

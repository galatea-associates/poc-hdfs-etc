...
public class MultiplePositionsOnSingleContract extends SwapQueryTest {
	...
	public void testEnrichedPositionsQuery() {
		...
		results.assertHasEnrichedPosition(new EnrichedPosition().ric("DEF").effectiveDate(20190101).swapId(12345)
				.counterPartyField1("cp200Field1").instId(22).counterPartyId(200));
		results.assertHasEnrichedPosition(new EnrichedPosition().ric("HIJ").effectiveDate(20190101).swapId(12345)
	...
	private void writePositions() {
		...
		new Position().position_type("S").swap_contract_id(12345).ric("DEF").effective_date(20190101).write();
		new Position().position_type("I").swap_contract_id(12345).ric("DEF").effective_date(20190101).write();
		new Position().position_type("E").swap_contract_id(12345).ric("DEF").effective_date(20190101).write();
		new Position().position_type("S").swap_contract_id(12345).ric("HIJ").effective_date(20190101).write();
		new Position().position_type("I").swap_contract_id(12345).ric("HIJ").effective_date(20190101).write();
		new Position().position_type("E").swap_contract_id(12345).ric("HIJ").effective_date(20190101).write();
	}
